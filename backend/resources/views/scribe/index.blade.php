...
<head>
    ...
    <title>Shaka POS API Documentation</title>
...
<p>Complete API documentation for Shaka Point of Sales system. Includes authentication, user management, product management, and transaction processing.</p>
<aside>
    <strong>Base URL</strong>: <code>http://localhost:8000</code>
</aside>
<pre><code>Welcome to the Shaka POS API documentation. This API powers our Point of Sales system built with Laravel 12+ and provides endpoints for:
...
&lt;aside&gt;The API uses Laravel Sanctum for authentication. Include your API token in the Authorization header for all authenticated requests.&lt;/aside&gt;</code></pre>
...
<p>This API is not authenticated.</p>
    ...
    <p>APIs for user authentication and authorization</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's email or username. Example: <code>admin@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Logout the authenticated user and revoke current access token</p>
...
<p>Get the authenticated user's information with roles and permissions</p>
...
<p>Refresh the user's access token by revoking current token and creating a new one</p>
